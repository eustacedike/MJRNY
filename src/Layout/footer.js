          ...
          <div className="border-top pt-4" style={{borderColor: "#1d1d1d !important"}}>
            <div className="row">
              <div className="col-md-6 text-center text-md-start">
                <p className="small text-muted mb-0">&copy; 
                {/* {new Date()} */}
                All rights reserved.</p>
              </div>
              <div className="col-md-6 text-center text-md-end">
                <p className="small text-muted mb-0">Managed by <a className="text-white reset-anchor" href="https://eustacedike.github.io/eustaced">Dev Eustace</a></p>
